...
optimizer = optim.SGD(list(model.model.parameters())+list(model.pooling.parameters())+list(model.post_pooling.parameters()), lr=args.lr_pase, momentum=args.momentum, weight_decay=args.l2)
