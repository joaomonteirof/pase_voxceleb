...
if args.model == 'resnet_18':
	...
	model = model_.TDNN_mfcc(n_z=args.latent_size, proj_size=train_dataset.n_speakers if args.softmax!='none' or args.pretrain else 0, ncoef=args.ncoef, sm_type=args.softmax)
elif args.model == 'MLP':
